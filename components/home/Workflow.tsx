          ...
          {content.workflowSteps.map((s, i) => (
            <Reveal key={i} delay={i * 0.1}>
              <div className="relative flex flex-col items-center text-center">
                <div className="liquid-clear relative z-10 mb-7 grid h-18 w-18 place-items-center rounded-[18px] p-5 text-foreground">
                  <Icon name={s.icon} className="h-7 w-7" />
                  <span className="absolute -right-2 -top-2 grid h-7 w-7 place-items-center rounded-full bg-foreground text-xs font-bold text-background">
